                     ...
                     <form onSubmit={this.SubmitData} >
                         <div className="account">
                             <div className="name-number">
                                <input type="text" className="form-control accountname" required name="accountname" placeholder="Account Name" />
                                <input type="text" className="form-control accountnumber" required name="accountnumber" placeholder="Account Number"/>
                             </div>
                             ...
                             <div className="amount">
                                <input type="text" className="form-control accountname" name="amount" required placeholder="Pay Per Hour" />
                            ...
                            <div className="referee">
                               <div className="name-email">
                                   <input type="text" className="form-control refname" required name="refname" placeholder="Referee Name" />
                               ...
                               <div className="relate-occu">
                                   <input type="text" className="form-control refrelate" required name="refrelate" placeholder="Relationship With Referee" />
                                   <input type="text" className="form-control refoccu" required name="refoccu" placeholder="Referee Occupation" />
                               </div>
                            </div>
