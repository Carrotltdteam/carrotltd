				...
				<Fade>
					<div className="profile-container">
						...
						<div id="content" className="content">
							...
							{this.state.data.education.completed === false ? (
								<Fade>
									{" "}
									<Education />{" "}
								</Fade>
							) : null}
							{this.state.data.licence.completed === false ? (
								<Fade>
									{" "}
									<Licence />
								</Fade>
							) : null}
							{this.state.data.bankReferee.completed === false ? (
								<Fade>
									{" "}
									<Bank />
								</Fade>
							) : null}
							{this.state.data.availability.completed === false ? (
								<Fade>
									{" "}
									<Availability />
								</Fade>
							) : null}
							{this.state.data.subject.completed === false ? (
								<Fade>
									<Subject />
								</Fade>
							) : null}
