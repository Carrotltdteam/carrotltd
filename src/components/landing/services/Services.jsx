        ...
        <div className="services-container">
            <div className="container">
                ...
                <div className="card">
                        ...
                        <p className="card-text">Connect with professionals 
                        in all subjects and skills you might want to learn.</p>
                    </div> 
                    <div className="card">
                        <div className="card-img" >
                        ...
                        <p className="card-text">We provide you the perfect tutor 
                        to work with your requirements and qualifications.</p>
                    </div> 
                    ...
                    <div className="card">
                        ...
                        <p className="card-text">Schedule a convenient 
                        time to meet your tutor and start your lessons.</p>
                    </div> 
                </div>
            </div>
        </div>
