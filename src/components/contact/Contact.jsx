						...
						<div className="contact-body-1">
							...
							<div className="body-1-right">
								<p className="right-text">
									Our head office is located at 3 William street, Sawmill road
									Gbagada, but we provide tutors anywhere in Nigeria and United
									Kingdom. Mondays-Saturdays, 8AM-6PM
								</p>
								...
								<div className="contact">
									...
									<div className="contact-info">
										...
										<p>
											165 Shakespeare Road Gillingham, Kent. United Kingdom. ME7
											5QB
										</p>
