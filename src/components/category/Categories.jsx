			...
			<Fade duration={1500}>
				<div className="category-container">
					<div className="top">
						<h1>Category</h1>
						<p>
							<NavLink to="/">Home</NavLink> &gt; <span>Category</span>{" "}
						</p>
					</div>
						...
						<div className="body">
							<div className="buttons">
								<select
									...
									name="list"
									className="form-control list-cat"
								>
									<option selected={content} disabled>
										{content}
									</option>
								...
								<input
									...
									onClick={() => setContent("lower primary")}
									value="lower primary"
								/>
								<input
									type="button"
									...
									onClick={() => setContent("upper primary")}
									value="upper primary"
								/>
								<input
									type="button"
									className={
										content === "junior secondary"
											? "btn-category active"
											: "btn-category"
									}
									onClick={() => setContent("junior secondary")}
									value="junior secondary"
								/>
								<input
									type="button"
									className={
										content === "senior secondary"
											? "btn-category active"
											: "btn-category"
									}
									onClick={() => setContent("senior secondary")}
									value="senior secondary"
								/>
								<input
									type="button"
									className={
										content === "igcse" ? "btn-category active" : "btn-category"
									}
									onClick={() => setContent("igcse")}
									value="igcse"
								/>
								<input
									type="button"
									...
									onClick={() => setContent("jamb/utme")}
									value="jamb/utme"
								/>
								<input
									type="button"
									className={
										content === "waec" ? "btn-category active" : "btn-category"
									}
								...
								<input
									type="button"
									className={
										content === "sat" ? "btn-category active" : "btn-category"
									}
									onClick={() => setContent("sat")}
									value="sat"
								/>
								<input
									type="button"
									...
									onClick={() => setContent("ielts/toefl")}
									value="ielts/toefl"
								/>
								<input
									type="button"
								...
								<input
									type="button"
									className={
										content === "music" ? "btn-category active" : "btn-category"
									}
								...
								<input
									...
									onClick={() => setContent("undergraduate")}
									value="undergraduate"
								/>
								<input
									type="button"
									className={
										content === "professional exams"
											? "btn-category active"
											: "btn-category"
									}
									onClick={() => setContent("professional exams")}
									value="professional exams"
								/>
								<input
									type="button"
									className={
										content === "checkpoint exam"
											? "btn-category active"
											: "btn-category"
									}
									onClick={() => setContent("checkpoint exam")}
