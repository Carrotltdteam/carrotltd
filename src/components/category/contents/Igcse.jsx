...
function Igcse() {
    ...
    return (
        ...
        <div className="cat-container">
            ...
            <div className="cat-button"><h2>igcse</h2></div>
                <div className="cat-body">
                    <div className="card">
                        <div className="image"><img src={upper} alt="cat-caption" /></div>
                        <h2>IGCSE Maths Tutor</h2>
                        <p>Get a professional and experienced IGCSE maths 
                            home tutor today to help you in excel in your exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a professional and proficient IGCSE English Language Tutor today.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a home tutor that is experienced in teaching IGCSE Biology.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a professional and experienced IGCSE Chemistry tutor 
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced IGCSE Physics Tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced IGCSE History Tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced IGCSE Account Tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced IGCSE Economics Tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a good and proficient IGCSE Geography Tutor to help you prepare for 
                            your upcoming IGCSE exams.
                        </p>
                    </div>
                </div>
            </div>
