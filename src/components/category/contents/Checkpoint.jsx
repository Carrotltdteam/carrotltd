				...
				<div className="cat-content">
					...
					<div className="cat-body">
						<div className="card">
							...
							<p>
								Hire an experienced and professional checkpoint exam maths tutor
								today.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire a professional and experienced Checkpoint exam English
								tutor today.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire an experienced Check Point Exam Science Tutor to help you
