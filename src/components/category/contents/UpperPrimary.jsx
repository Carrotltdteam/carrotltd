				...
				<div className="cat-content">
					...
					<div className="cat-body">
						<div className="card">
							...
							<p>
								Get a professional upper primary maths tutor to help increase
								your mathematics grades.
							</p>
						</div>

						<div className="card">
							<div className="image">
								<img src={upper1} alt="cat-caption" />
							</div>
							<h2>Common Entrance Math Tutor</h2>
							<p>
								Get an experienced professional common entrance mathematics
								tutor to prepare for common entrance exams.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Get a professional English Language home tutor to help your
								child in his reading, grammar, and speaking English fluently.
							</p>
						</div>

						<div className="card">
							<div className="image">
								<img src={upper2} alt="cat-caption" />
							</div>
							<h2>Common Entrance English Tutor</h2>
							<p>
								Get a professional common entrance English tutor today to help
								prepare your child for the upcoming common entrance exam.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire tutors that are proficient in teaching social studies,
								physical education, vocational studies, art and crafts
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire an experienced Upper Primary Math Tutor to teach you with
								the British curriculum at your convenience.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire a professional home tutor that would help you in
								preparation for Common Entrance Math exams today.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire a professional home tutor that would help you in
								preparation for Common Entrance Math using the American
								curriculum.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire an experienced Upper Primary English Tutor to teach you,
								vocabulary, reading, literacy, grammar, verbal reasoning,
								writing and speaking with the British curriculum.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire a professional and experienced Upper Primary Creative
								Writing Tutor to help you in difficult areas of your creative
								compositions.
							</p>
						</div>
