...
function Waec() {
    ...
    return (
        ...
        <div className="cat-container">
            ...
            <div className="cat-button"><h2>waec</h2></div>
                <div className="cat-body">
                    <div className="card">
                        <div className="image"><img src={j} alt="cat-caption" /></div>
                        <h2>WAEC Math Tutor</h2>
                        <p>Hire an experienced and professional WAEC mathematics tutor 
                    ...
                    <div className="card">
                        ...
                        <p>Hire a Professional English Language Tutor to help you with exam preparations.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced Waec Physics tutor to help you in passing your exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced Waec Further Maths Tutor to help with exams preparations.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a professional and experienced Waec Chemistry Tutor to help you with your exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced Waec Biology Tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a good tutor to help you prepare for your government exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a professional and experienced accounting tutor to help you in your waec exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a tutor experienced in teaching Government, Commerce, History, 
                            Economics and Sociology to help you prepare for your upcoming WAEC exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a good agric science tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a good Literature in English tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                </div>
            </div>
