				...
				<div className="cat-content">
					...
					<div className="cat-body">
						<div className="card">
							...
							<p>
								Learn to speak mandarin and other chinese languages with the
								help of our language expert home tutors
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								The importance of speaking, reading and writing properly is the
								essence of education. Get an English home tutor to help you
								build yourself on these skills.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>Hire an experienced Spanish Language Tutor today.</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Hire a good and experienced French Language Tutor today to help
								you learn French.
							</p>
						</div>
						...
						<div className="card">
							...
							<p>
								Learn to speak Yoruba fluently by getting a Professional Yoruba
						...
						<div className="card">
							...
							<p>Learn to speak Hause hire a Hausa Language Tutor today.</p>
						</div>
						...
						<div className="card">
							...
							<p>Hire a home tutor to teach you Igbo Language.</p>
						</div>
						...
						<div className="card">
							...
							<p>Hire an experienced German Language Tutor today.</p>
						</div>
						...
						<div className="card">
							...
							<p>Hire an experienced Portuguese Language Tutor today.</p>
						</div>
					</div>
				</div>
			</div>
