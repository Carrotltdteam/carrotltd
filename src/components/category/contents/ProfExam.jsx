...
function ProfExam() {
    ...
    return (
        ...
        <div className="cat-container">
            ...
            <div className="cat-button"><h2>professional exams</h2></div>
                <div className="cat-body">
                    <div className="card">
                        <div className="image"><img src={upper9} alt="cat-caption" /></div>
                        <h2>ICSAN</h2>
                        <p>Get a Professional ICSAN tutor and you would never go wrong hiring from Educere.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire a professional and experienced GMAT Quantitative 
                            Tutor to help you prepare for your upcoming exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced and good GRE Verbal Tutor to help you prepare for GRE exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an expert to help you prepare for your GRE Quantitative exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <h2>ICAN Tutor</h2>
                        <p>Hire an experienced ICAN Tutor to help you in preparing for your exams.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        <div className="image"><img src={j2} alt="cat-caption" /></div>
                        <h2>ACCA Tutor</h2>
                        <p>Are you currently preparing for ACCA? No need to worry, all you just need
                            is to get a Professional ACCA tutor from Educere.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Hire an experienced and good GMAT Verbal Tutor to help you in GMAT.
                        </p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <h2>SHL</h2>
                        <p>Hire an experienced SHL Tutor to help you in preparing for your exams.
                        </p>
                    </div>
                </div>
            </div>
